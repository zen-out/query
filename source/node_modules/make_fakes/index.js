! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.make_fakes = t() : e.make_fakes = t() }(this, (function() {
    return (() => {
        "use strict";
        var e = { d: (t, o) => { for (var n in o) e.o(o, n) && !e.o(t, n) && Object.defineProperty(t, n, { enumerable: !0, get: o[n] }) }, o: (e, t) => Object.prototype.hasOwnProperty.call(e, t), r: e => { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }) } },
            t = {};
        ...
        e.r(t), e.d(t, { createMany: () => k, createManyDirty: () => _, createOne: () => g, createOneDirty: () => b, getOne: () => w });
        var n = Object.prototype.hasOwnProperty,
            r = Object.prototype.toString,
            a = Object.defineProperty,
            i = Object.getOwnPropertyDescriptor,
            s = function(e) { return "function" == typeof Array.isArray ? Array.isArray(e) : "[object Array]" === r.call(e) },
            u = function(e) {
        ...
        function p(e, t) { return e = Math.ceil(e), t = Math.floor(t), Math.floor(Math.random() * (t - e) + e) }
        var v = function() {
                ...
                return t = e, o = [{
                    ...
                    value: function() {
                        var e = p(1, 2e3),
                            t = p(1, 99);
                        return parseFloat([e, ".", t].join(""))
                    }
                }, { key: "paragraph", value: function() { return this.getArrayOptions(c) } }, { key: "boolean", value: function() { return p(1, 2e3) % 2 == 0 } }, {
                    key: "number",
                    value: function() {
                ...
                }, { key: "string", value: function() { var e = this.getArrayOptions(c).split(" "); return this.getArrayOptions(e) } }, { key: "email", value: function() { var e; return (e = ["joelw@optonline.net", "kspiteri@outlook.com", "garyjb@att.net", "jbryan@outlook.com", "jigsaw@gmail.com", "cgreuter@icloud.com", "euice@sbcglobal.net", "burns@att.net", "sabren@icloud.com", "kidehen@me.com", "arachne@mac.com"])[p(0, e.length - 1)] } }, {
                    key: "date",
                    value: function() {
                        var e = p(0, 11),
                            t = p(1, 25);
                        return new Date(2022, e, t)
                    }
                }, {
                    key: "password",
                    value: function() {
                        var e = this.randomString(),
                            t = this.randomString().toUpperCase();
                        return e + this.randomNum(3, 24) + t
                    }
                }, {
                    key: "past_date",
                    value: function() {
        ...
        function w(e) {
            if ("string" != typeof e) return y.getArrayOptions(e);
            switch (e) {
                case "paragraph":
                    return y.paragraph();
                case "boolean":
                ...
                case "image":
                    return y.image();
                default:
                    return y.getArrayOptions(e)
            }
        }

        function g(e) {
            for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = arguments.length > 2 ? arguments[2] : void 0, n = Object.keys(e), r = {}, a = 0; a < n.length; a++) {
                var i = n[a],
                    s = e[i];
                if ("foreign_id" === s) r[i] = o;
                else {
                    var u = w(s);
                    r[i] = u
                }
        ...
        function k(e) {
            for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, r = [], a = 0; a < t; a++) {
                var i = a + 1,
                    s = g(e, n, i);
                !0 === o && (s.id = i), r.push(s)
            }
